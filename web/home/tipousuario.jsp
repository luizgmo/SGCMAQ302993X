    ...
    <body>
        ...
        <table>
            ...
            <tr>
                ...
                <td><a href="<%= request.getContextPath() %>/home/tipousuario?action=delete&id=<%= tp.getId() %>" onclick="return confirm('Deseja realmente excluir Tipo Usuário <%= tp.getId() %> (<%= tp.getNome() %>) ?')" >Excluir</a></td>
            </tr>
            <% } %>
